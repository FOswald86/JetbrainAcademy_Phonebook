...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        List<String> directory = Files.readAllLines(Paths.get("C:\\Users\\frank\\Downloads\\directory.txt"));
        List<String> find = Files.readAllLines(Paths.get("C:\\Users\\frank\\Downloads\\find.txt"));
